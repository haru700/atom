...
var TypeTransformer = (function (_super) {
    ...
    function TypeTransformer(dumpXMLRepresentationOfExamples) {
        ...
        this.dumpXMLRepresentationOfExamples = dumpXMLRepresentationOfExamples;
    }
    TypeTransformer.prototype.transform = function (_value, node) {
        ...
        var exampleObj = helpersHL.typeExample(node.asElement(), this.dumpXMLRepresentationOfExamples);
        if (exampleObj) {
            value["examples"] = [exampleObj];
        }
        else {
            var examples = helpersHL.typeExamples(node.asElement(), this.dumpXMLRepresentationOfExamples);
