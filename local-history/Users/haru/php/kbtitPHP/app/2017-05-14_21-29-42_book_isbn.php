<?php
// ライブラリの読み込み
ini_set('include_path', ini_get('include_path').PATH_SEPARATOR."/Users/haru/php/kbtitPHP/src/google-api-php-client-services/src");

ini_set('include_path', ini_get('include_path').PATH_SEPARATOR."/Users/haru/php/kbtitPHP/src");
require_once ('/Users/haru/php/kbtitPHP/src/google-api-php-client-services/src/Google/Service/Client.php');
