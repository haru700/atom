...
# @Last modified time: 2017-05-26T11:43:23+09:00
...
// 追加された行数
print sprintf("%s行追加されました<br />", $diff->countAddLines() );

/// 削除された行数
print sprintf("%s行追加されました<br />", $diff->countDeletedLines() );

/// 一致している行数
print sprintf("%s行一致がありました<br />", $diff->lcs() );
