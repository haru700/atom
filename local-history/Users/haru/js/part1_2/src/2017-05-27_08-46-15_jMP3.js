/**
 * @Author: haru
 * @Date:   2017-05-27T08:24:35+09:00
 * @Last modified by:   haru
 * @Last modified time: 2017-05-27T08:46:15+09:00
 */
 /***
 ...
 ***/
 jQuery.fn.jmp3 = function(passedOptions){
 	// hard-wired options
 	var playerpath = "/Users/haru/js/src/singleMP3player/flutter/js/singlemp3player.swf";					// SET THIS FIRST: path to singlemp3player.swf
    ...
    console.log('=============='); console.table('browser'
    + Object.getPrototypeOf(jQuery.browser) ); console.log('==============');
