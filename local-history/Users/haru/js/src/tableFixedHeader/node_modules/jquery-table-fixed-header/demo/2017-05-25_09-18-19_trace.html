...
<table class="gridview data" cellspacing="0" rules="all" border="1" id="table1">
	<thead>
	<tr>
...
<script language="JavaScript" type="text/javascript" src="../src/jquery.table-fixed-header.js"></script>
<script type="text/javascript">
	$(function ($) {
		$('#table1').fixheadtable({
			caption: '作曲者情報',
			colratio: [200, 150, 150, 100, 50],
			height: 300,
			width: 670,
		});
	});
